    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__OcjenaDo__E6FC7AA918CA1BB2", x => x.OcjenaId);
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1001, "Arijana", "admin", "HjHsXY8Ji9exC1L1pvALv4AxUsU=", "YSEB9QuSNNeJrQvsY2qd9Q==", "Husic" },
                    { 1002, "Medisa", "korisnik", "QQdKWKFIQAPR3j5lyM3CP3X/B/M=", "c+2R9OCOoKnm0o3jw++5KQ==", "Satara" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 6, 9, 19, 5, 33, 724, DateTimeKind.Local).AddTicks(4095), 1001, 1 },
                    { 2, new DateTime(2024, 6, 9, 19, 5, 33, 724, DateTimeKind.Local).AddTicks(4154), 1002, 2 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 5001, "Ne", "14B579", "1998-12-11", "Nema", "Josip", "1211998796541", false, "pacijent1", 1002, "AB", "wBnqYPAJDYMg/dOjegCJTGmn3MQ=", "QBcFkKnJRXD3syaYhXe9kQ==", "Mostar", "Mostar", "Bojcic", "+", "M", "061 201 022" },
                    { 5002, "Antibiotik", "19378A", "1980-05-08", "Nema", "Helena", "5089801236547", false, "Pacijent2", 1002, "A", "ReNAjExNozjgJp+sbf5s6DX/7Gc=", "QBcFkKnJRXD3syaYhXe9kQ==", "Mostar", "Mostar", "Radic", "+", "Z", "062 201 022" },
                    { 5003, "Ne", "8537C", "1992-11-12", "Nema", "Melita", "5089801236547", false, "pacijent3", 1002, "AB", "NquHQPzCEJk2qo5ILqcVX2/ckpo=", "QBcFkKnJRXD3syaYhXe9kQ==", "Stolac", "Mostar", "Golubica", "-", "Z", "063 991 022" }
                });
