...
namespace eKarton.Service.Migrations
{
    ...
    [Migration("20240609170534_initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("eKarton.Service.Database.Administrator", b =>
                {
            ...
            modelBuilder.Entity("eKarton.Service.Database.Bolnica", b =>
                {
                    b.Property<int>("BolnicaId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("eKarton.Service.Database.DodjeljeniDoktor", b =>
                {
            ...
            modelBuilder.Entity("eKarton.Service.Database.Doktor", b =>
                {
                    b.Property<int>("DoktorId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("eKarton.Service.Database.Korisnik", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Ime = "Arijana",
                            KorisnickoIme = "admin",
                            LozinkaHash = "HjHsXY8Ji9exC1L1pvALv4AxUsU=",
                            LozinkaSalt = "YSEB9QuSNNeJrQvsY2qd9Q==",
                            Prezime = "Husic"
                        },
                        new
                        {
                            ...
                            LozinkaHash = "QQdKWKFIQAPR3j5lyM3CP3X/B/M=",
                            LozinkaSalt = "c+2R9OCOoKnm0o3jw++5KQ==",
                            Prezime = "Satara"
                        });
                });

            modelBuilder.Entity("eKarton.Service.Database.KorisnikUloga", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            KorisnikUlogaId = 1,
                            DatumIzmjene = new DateTime(2024, 6, 9, 19, 5, 33, 724, DateTimeKind.Local).AddTicks(4095),
                            KorisnikId = 1001,
                            UlogaId = 1
                        },
                        new
                        {
                            KorisnikUlogaId = 2,
                            DatumIzmjene = new DateTime(2024, 6, 9, 19, 5, 33, 724, DateTimeKind.Local).AddTicks(4154),
                            KorisnikId = 1002,
                            UlogaId = 2
                        });
                });

            modelBuilder.Entity("eKarton.Service.Database.Nalaz", b =>
                {
            ...
            modelBuilder.Entity("eKarton.Service.Database.Oboljenje", b =>
                {
            ...
            modelBuilder.Entity("eKarton.Service.Database.OcjenaDoktor", b =>
                {
            ...
            modelBuilder.Entity("eKarton.Service.Database.Odjel", b =>
                {
                    b.Property<int>("OdjelId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("eKarton.Service.Database.Osiguranje", b =>
                {
            ...
            modelBuilder.Entity("eKarton.Service.Database.Pacijent", b =>
                {
                    b.Property<int>("PacijentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            KorisnikId = 1002,
                            KrvnaGrupa = "AB",
                            LozinkaHash = "wBnqYPAJDYMg/dOjegCJTGmn3MQ=",
                            LozinkaSalt = "QBcFkKnJRXD3syaYhXe9kQ==",
                        ...
                        new
                        {
                            ...
                            KorisnikId = 1002,
                            KrvnaGrupa = "A",
                            LozinkaHash = "ReNAjExNozjgJp+sbf5s6DX/7Gc=",
                            LozinkaSalt = "QBcFkKnJRXD3syaYhXe9kQ==",
                            MjestoRodjenja = "Mostar",
                            Prebivaliste = "Mostar",
                            Prezime = "Radic",
                        ...
                        new
                        {
                            ...
                            KorisnikId = 1002,
                            KrvnaGrupa = "AB",
                            LozinkaHash = "NquHQPzCEJk2qo5ILqcVX2/ckpo=",
                            LozinkaSalt = "QBcFkKnJRXD3syaYhXe9kQ==",
            ...
            modelBuilder.Entity("eKarton.Service.Database.PacijentOboljenja", b =>
                {
            ...
            modelBuilder.Entity("eKarton.Service.Database.PacijentOsiguranje", b =>
                {
            ...
            modelBuilder.Entity("eKarton.Service.Database.PacijentVakcinacija", b =>
                {
            ...
            modelBuilder.Entity("eKarton.Service.Database.Pregled", b =>
                {
            ...
            modelBuilder.Entity("eKarton.Service.Database.PreventivneMjere", b =>
                {
            ...
            modelBuilder.Entity("eKarton.Service.Database.SistematskiPregled", b =>
                {
            ...
            modelBuilder.Entity("eKarton.Service.Database.Terapija", b =>
                {
                    b.Property<int>("TerapijaId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("eKarton.Service.Database.Termin", b =>
                {
            ...
            modelBuilder.Entity("eKarton.Service.Database.Uloga", b =>
                {
                    b.Property<int>("UlogaId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("eKarton.Service.Database.Uputnica", b =>
                {
                    b.Property<int>("UputnicaId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("eKarton.Service.Database.Vakcinacija", b =>
                {
                    b.Property<int>("VakcinacijaId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("eKarton.Service.Database.Administrator", b =>
                {
                    b.HasOne("eKarton.Service.Database.Bolnica", "Bolnica")
            ...
            modelBuilder.Entity("eKarton.Service.Database.DodjeljeniDoktor", b =>
                {
                    b.HasOne("eKarton.Service.Database.Doktor", "Doktor")
                        .WithMany("DodjeljeniDoktors")
                        .HasForeignKey("DoktorId")
                        .IsRequired()
                        .HasConstraintName("FK_Doktor_DodjeljeniDoktor");

                    b.HasOne("eKarton.Service.Database.Pacijent", "Pacijent")
                        .WithMany("DodjeljeniDoktors")
            ...
            modelBuilder.Entity("eKarton.Service.Database.Doktor", b =>
                {
                    b.HasOne("eKarton.Service.Database.Odjel", "Odjel")
                        .WithMany("Doktors")
            ...
            modelBuilder.Entity("eKarton.Service.Database.KorisnikUloga", b =>
                {
                    b.HasOne("eKarton.Service.Database.Korisnik", "Korisnik")
                        .WithMany("KorisnikUlogas")
                        .HasForeignKey("KorisnikId")
                        .HasConstraintName("FK_Korisnik_KorisnikUloga");

                    b.HasOne("eKarton.Service.Database.Uloga", "Uloga")
                        .WithMany("KorisnikUlogas")
            ...
            modelBuilder.Entity("eKarton.Service.Database.PacijentOboljenja", b =>
                {
                    b.HasOne("eKarton.Service.Database.Oboljenje", "Oboljenje")
            ...
            modelBuilder.Entity("eKarton.Service.Database.PacijentOsiguranje", b =>
                {
                    b.HasOne("eKarton.Service.Database.Osiguranje", "Osiguranje")
            ...
            modelBuilder.Entity("eKarton.Service.Database.PacijentVakcinacija", b =>
                {
                    ...
                    b.HasOne("eKarton.Service.Database.Vakcinacija", "Vakcinacija")
                        .WithMany("PacijentVakcinacijas")
            ...
            modelBuilder.Entity("eKarton.Service.Database.Pregled", b =>
                {
                    ...
                    b.HasOne("eKarton.Service.Database.Terapija", "Terapija")
                        .WithMany("Pregleds")
                        .HasForeignKey("TerapijaId")
                        .IsRequired()
                        .HasConstraintName("FK_Terapija_Pregled");

                    b.HasOne("eKarton.Service.Database.Uputnica", "Uputnica")
                        .WithMany("Pregleds")
